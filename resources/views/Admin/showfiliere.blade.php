...
<div class="head-title">
    <div class="left">
        ...
        <ul class="breadcrumb">
            ...
            <li>
                <a class="active" href="{{ route('Admin.Filiere') }}">{{ $filiere->Nom  }}</a>
            </li>
            <li><i class='bi bi-chevron-right' ></i></li>
            <li>
    ...
    <div>
        <a href="javascript:void(0)" class="btn-download" id="tele" onclick="document.getElementById('niveaus').classList.add('show'); document.getElementById('tele').style.display = 'none';">
            <i class="bi bi-cloud-download-fill"></i>
            <span class="text">Télécharger</span>
        </a>
        <div class="annee" id="niveaus" >
            <span onclick="document.getElementById('inNiveau').value='1èr année';document.getElementById('Niveau').submit();">1èr année</span>
            <span onclick="document.getElementById('inNiveau').value='2ème année';document.getElementById('Niveau').submit();">2ème année</span>
         </div>
    </div>
    <form action="{{ route('Admin.Filiere.pdf',$filiere->id) }}" method="POST" id="Niveau" style="display: none">
        @csrf
        <input type="hidden" name="Niveau" value="" id="inNiveau">
    </form>
</div>
            ...
            <tbody>
                ...
                @if (count($etudiants)>0)
                    ...
                    <tr >
                        ...
                        <td class="center"><span class="status i completed" style="cursor: pointer" onclick="edit({{ $etudiant}});"><i class="bi bi-pen-fill"></i></span></td>
                        <td class="center"><span class="status i process" style="cursor: pointer" onclick="show({{ $etudiant }});"><i class="bi bi-eye-fill"></i></span></td>
                        <td class="center"><span class="status i pending" style="cursor: pointer" onclick="sup({{ $etudiant->id }});"><i class="bi bi-trash2-fill"></i></span></td>
                    </tr>
                    @endforeach
                @else   
                    <tr>
...
<script>
    ...
    function show(etudiant){
        ...
        document.getElementById('CIN1').innerText = etudiant.CIN;
